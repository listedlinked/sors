...
In order to support loading of multiple wallets in sors-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sors.cpp.
...
Changes to sors.cpp
----------------------
sors.cpp is the entry point into sors-qt, and as such, will require some minor modifications to provide hooks for
