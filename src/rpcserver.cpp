...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* sors features */
        {"sors", "masternode", &masternode, true, true, false},
        {"sors", "masternodelist", &masternodelist, true, true, false},
        {"sors", "mnbudget", &mnbudget, true, true, false},
        {"sors", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"sors", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sors", "mnsync", &mnsync, true, true, false},
        {"sors", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"sors", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sorsd, or the -server option to sors-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sors-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:60100/\n";
}
