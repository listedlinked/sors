...
RESOURCES += src/qt/sors.qrc src/qt/sors_locale.qrc

TRANSLATIONS += src/qt/locale/sors_bg.ts \
                src/qt/locale/sors_de.ts \
                src/qt/locale/sors_en.ts \
                src/qt/locale/sors_es.ts \
                src/qt/locale/sors_fi.ts \
                src/qt/locale/sors_fr.ts \
                src/qt/locale/sors_it.ts \
                src/qt/locale/sors_ja.ts \
                src/qt/locale/sors_pl.ts \
                src/qt/locale/sors_pt.ts \
                src/qt/locale/sors_ru.ts \
                src/qt/locale/sors_sk.ts \
                src/qt/locale/sors_sv.ts \
                src/qt/locale/sors_vi.ts \
                src/qt/locale/sors_zh_CN.ts \
                src/qt/locale/sors_zh_TW.ts
